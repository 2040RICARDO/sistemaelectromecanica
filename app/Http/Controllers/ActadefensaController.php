...
class ActadefensaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->select('a.idacta_defensa','p.nombresapellidos as postulante','te.titulo_tema as tema_perfil','a.fecha_defensa','a.hora_defensa','a.modalidad','a.puntaje','a.valoracion','a.obs_recomendaciones','a.estadoss')
    ...
    public function create()
    {
        ...
        $tema_perfils=DB::table('tema_perfil')->where('estados','=','defendido')->get();
        $postulantes=DB::table('postulante')->where('estado','=','Activo')->get();
        return view("uno.acta_defensa.create",["tema_perfils"=>$tema_perfils,"postulantes"=>$postulantes]);
       
    }
    public function store (ActadefensaFormRequest $request)
    {
      	$acta_defensa=new Acta_defensa;
    	$acta_defensa->idacta_defensa=$request->get('idacta_defensa');
    	$acta_defensa->idpostulante=$request->get('idpostulante');
    	...
    	$acta_defensa->modalidad=$request->get('modalidad');
    ...
    public function edit($id)
    {
        ...
        $tema_perfils=DB::table('tema_perfil')->where('estados','=','defendido')->get();
        $postulantes=DB::table('postulante')->where('estado','=','Activo')->get();
        return view("uno.acta_defensa.edit",["acta_defensa"=>$acta_defensa,"tema_perfils"=>$tema_perfils,"postulantes"=>$postulantes]);
    }
    ...
    public function reportec($id)
    {
           ...
           /* $acta_defensas=DB::table('acta_defensa as a')
            ->join('tema_perfil as te','a.idtema_perfil','=','te.idtema_perfil')
            ->join('postulante as p','a.idpostulante','=','p.idpostulante')
            ->join('tribunal as t','p.idpostulante','=','t.idpostulante')
            ->select('a.idacta_defensa','p.nombresapellidos as postulante','te.titulo_tema as tema_perfil','a.hora_defensa','a.fecha_defensa','a.modalidad','a.puntaje','a.valoracion','a.obs_recomendaciones','a.estadoss','t.nombre_tri1','t.nombre_tri2','t.nombre_tri3')
            ->where('a.idpostulante',$id)
            ->first();*/

            $acta_defensas=DB::table('acta_defensa as a')
            ->join('tema_perfil','a.idtema_perfil','=','tema_perfil.idtema_perfil')
            ->join('postulante','a.idpostulante','=','postulante.idpostulante')
            ->join('tribunal','postulante.idpostulante','=','tribunal.idpostulante')
            ->join('docente as d','tribunal.iddocente','=','d.iddocente')
            ->select('titulo_tema','a.fecha_defensa','a.modalidad','a.puntaje','a.hora_defensa','a.obs_recomendaciones','nombresapellidos','d.nombre','nombre_tri1','nombre_tri2')
    ...
    public function reporte()
    {
        $registros=DB::table('acta_defensa as a')
            ->join('tema_perfil as te','a.idtema_perfil','=','te.idtema_perfil')
            ->join('postulante as p','a.idpostulante','=','p.idpostulante')
           ->select('a.idacta_defensa','p.nombresapellidos as postulante','te.titulo_tema as tema_perfil','a.hora_defensa','a.hora_defensa','a.modalidad','a.puntaje','a.valoracion','a.obs_recomendaciones','a.estadoss')
             ->where ('estadoss','=','a')
           ->orderBy('a.puntaje','asc')
        ->get();
