...
<body>
	...
	<table  align="center" border="1">
          ...
          <tr style=" background: #84ffff; color:#000;" b>
            ...
            <th style="width:60px;font-size: 70%;" align="center">C.I.</th>
            <th style="width:100px;font-size: 70%;" align="center"> Docente/Tutor </th>
        ...
        <td align="center" style="font-size: 60%;">{{ $datos->ci}}</td>
        <td style="width:100px;font-size: 60%;">{{ $datos->docente}}</td>
      </tr>
       {{-- */ $rh = $rh+1; /*--}} 
      @endforeach
