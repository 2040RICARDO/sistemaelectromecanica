...
<div class="row">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 -col-xs-12"> 
		...
		<a href="tribunal/create"><button class="btn btn-succes"><span data-toggle="tooltip" title class="badge bg-light-blue" data-original-title="Nuevo registro">+</span> Nuevo</button></a> 
		@endif
