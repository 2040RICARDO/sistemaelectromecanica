		...
		<div class="box-body"> 
			<table class="table table-bordered table-striped" id="general">
				...
				<tr>
					...
					@if(Auth::user()->tipo_user == 1) 
					<td><a href="{{URL::action('TemaperfilController@edit',$general->idtema_perfil)}}"><button data-toggle="tooltip" title data-original-title="Editar el registro" class="btn bg-navy btn-xs">Editar</button></a>
